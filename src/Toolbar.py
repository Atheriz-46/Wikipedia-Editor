...
class Toolbar(tk.Frame):
	...
	def __init__(self, parent, guimanager):
		...
		self.btn_new_home = ttk.Button(master = self.frm_home, text = "New Page", command = self.newPage(self.frm_home))

		self.ent_view = tk.Entry()
		self.btn_new_view = ttk.Button(master = self.frm_view, text = "New Page", command = self.newPage(self.frm_view))
